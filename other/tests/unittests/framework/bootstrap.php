	...
	class TEST_main extends PHPDS
	{
		...
		public static function instance()
		{
			if (empty(TEST_main::$_instance)) {
                $instance = new TEST_main(true);
                $instance->config();
                TEST_main::$_instance = $instance;
			}
        ...
        {
            return parent::configDb();
        }

        /**
         * Override the standard method to provided a test database object
         *
         * @return TEST_stubDB
         */
        ...
        {
            if (empty($this->db)) {
                $this->db = $this->_factory('TEST_stubDB');
            }
            return $this->db;
        }
         ...
         * @return bool
         */
        public function includeConfigFile($path, &$configuration)
        {
            return parent::includeConfigFile($path, $configuration);
        }
         ...
         * @return bool
         */
        public function loadConfigFile($filename, &$configuration)
        {
            return parent::loadConfigFile($filename, $configuration);
        }
	}
